...
//
// These require a running Asterisk instance. Configure via environment:
//
//	ASTERISK_ARI_URL=http://172.27.255.250:8088
//	ASTERISK_ARI_USER=api
//	ASTERISK_ARI_PASS=u8b29nasnflorgg
//
// Run:
//
...
func ariURL() string {
	if v := os.Getenv("ASTERISK_ARI_URL"); v != "" {
		return v
	}
	return "http://172.27.255.250:8088"
}

func ariUser() string {
	if v := os.Getenv("ASTERISK_ARI_USER"); v != "" {
		return v
	}
	return "api"
}
...
func ariPass() string {
	if v := os.Getenv("ASTERISK_ARI_PASS"); v != "" {
		return v
	}
	return "u8b29nasnflorgg"
}
